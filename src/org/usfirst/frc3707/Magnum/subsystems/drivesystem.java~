...
public class drivesystem extends Subsystem {
    ...
    public void drive(double leftcontrollerspeed, double rightControllerspeed) {
    ...
    public void joystickDrive () {
    	drive(Robot.oi.joystickLeft.getAxis(Joystick.AxisType.kY), Robot.oi.joystickRight.getAxis(Joystick.AxisType.kY));
    	}
